...
/*\Bitrix\Main\Page\Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/css/page-checkout.css?v=1",true);
\Bitrix\Main\Page\Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/css/page-shops.css?v=1",true);
\Bitrix\Main\Page\Asset::getInstance()->addJs($templateFolder . "/checkout.js");*/
...
<div class="checkout-box" id="bx-belleyou-checkout-container">
    ...
    <div class="checkout-body" name="ORDER_FORM" id="bx-soa-order-form">
        ...
        <section class="checkout-step personal-data">
            <div class="h2 checkout-step-title">1. Покупатель</div>
        ...
        <section class="checkout-step delivery">
            <div class="h2 checkout-step-title">2. Способ доставки</div>
            ...
            <div class="checkout-delivery-information">
                ...
                <div class="checkout-desc-text">
                    ...
                    <p>Сроки доставки в Беларусь, Казахстан, Краснодар, Анапу, Геленджик, Симферополь могут быть увеличены на 5 дней.</p>
            ...
            <div id="radio-block-1" class="checkout-delivery-radioblock checkout-delivery-address" data-checkout="form.delivery-address">
                ...
                <div class="delivery-courier-check" data-checkout="form.delivery-address.services">
                    <div class="h3 page-checkout-subtitle">Курьерская служба</div>
                ...
                <div class="delivery-address">
                    <div class="h3 page-checkout-subtitle">Адрес доставки</div>
            ...
            <div id="radio-block-2" class="checkout-delivery-radioblock checkout-delivery-selfservice" data-checkout="form.delivery-pvz">
                <div class="h3 page-checkout-subtitle">пункт самовывоза</div>
            ...
            <div id="radio-block-4" class="checkout-delivery-radioblock checkout-delivery-shop" data-checkout="form.delivery-branch">
                <div class="h3 page-checkout-subtitle">Магазин</div>
        ...
        <section class="checkout-step payment-data">
            <div class="h2 checkout-step-title">3. Способ оплаты</div>
    ...
    <aside class="checkout-sidebar">
        <div class="checkout-sidebar-sticky">
            <div class="checkout-items-list">
                <div class="h3 checkout-items-title">товары</div>
            ...
            <div class="h3 checkout-summary-title">Ваш заказ</div>
            ...
            <div style="display: none; color: red; margin-bottom: 15px; text-align: center;" class="auth_error"></div>
...
<?if($_REQUEST['yes'] == 1){
    ?><pre><?print_r($_SESSION['SESS_GUEST_ID'])?></pre><?
}?>

<?if($USER->isAuthorized()){
    $userID = $USER->getID();    
}elseif(!empty($_SESSION['SESS_GUEST_ID'])){
    $userID = $_SESSION['SESS_GUEST_ID'];    
}?>
        ...
        BX.ready(() => {
            BX.Sale.Checkout
                .instance('bx-belleyou-checkout-container', {
                    ...
                    certificate_ids: [91990, 92411, 92418, 92423, 98249, 98258, 98263],

                ...
                foreach ($arResult["PAYMENT"] as $payment)
                {
                    if ($payment["PAID"] != 'Y')
                    {
                        ...
                        )
                        {
                            ...
                            $isCert = false;
                            $isCert = $payment['PAY_SYSTEM_ID'] == 9;
                            ...
                            if (empty($arPaySystem["ERROR"]))
                            {
                                if($arPaySystem["IS_CASH"] !== 'Y'){
                                    ...
                                    <div class="checkout-box-success">
                                        ...
                                        <div class="checkout-success-buttons">
                                            <a class="button" href="<?=htmlentities($sPaymentLink)?>">
                                                <?php if($isPodeli) : ?>
                                                    Оплатить частями
                                                <?php elseif($isCert) : ?>
                                ...
                                else
                                {
                                    ...
                                    <?php if ((int)$_COOKIE["order_complete"] !== (int)$arResult["ORDER"]["ID"]) { ?>
                                        <?
                                        $gPurchase = json_encode([        
                                            "event" => "purchase",
                                            "event_category" => "ecommerce",
                                    ...
                                    <div class="checkout-box-success">
                                        ...
                                        <div class="checkout-success-text">
                                            ...
                                            <p>Если у вас остались вопросы, свяжитесь с нами по бесплатному номеру телефона <a href="tel:+78003338722">8–800–333–87–22</a></p>

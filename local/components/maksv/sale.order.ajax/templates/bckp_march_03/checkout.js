...
(function() {
    ...
    BX.Sale.Checkout = class Checkout {
        ...
        getSelectedDelivery(defaultDelivery = null){
            const deliveryID = this.getFromStorage('checkoutCurrentDeliveryID')
            var cityInputVal = $(".suggestions-input").val();
            
            console.log('suggestions-input', cityInputVal)
            console.log('getSelectedDelivery', deliveryID)
            console.log('args', this.args)
            
            if(!deliveryID || !this.args['DELIVERY'] || !this.args['DELIVERY'][deliveryID + '']){
                if(cityInputVal){

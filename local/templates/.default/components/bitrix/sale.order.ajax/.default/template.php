...
$this->addExternalCss("/local/templates/maksv/css/page-checkout.css");
$this->addExternalCss("/local/templates/maksv/css/page-shops.css");
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-orderSave">
					...
					<a href="javascript:void(0)" style="margin: 10px 0" class="pull-right <?/*btn btn-default*/?> button white-color-font btn-lg hidden-xs" data-save-button="true">
						<?=$arParams['MESS_ORDER']?>
					</a>
				</div>

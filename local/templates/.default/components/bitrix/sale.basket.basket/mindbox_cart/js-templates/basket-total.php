...
<script id="basket-total-template" type="text/html">
    ...
    {?>
        <div class="basket-discounts-box">
            <?#if($USER->isAdmin()){?>
                ...
                {{#COUPON_LIST}}
                    <p class="basket-discount-applied certificate1-applied basket-coupon-result{{CLASS}}">Сертификат {{COUPON}} применен 
                        <button class="button-delete-discount delete_certificate" data-discount-delete="certificate" data-entity="basket-coupon-delete" data-coupon="{{COUPON}}"></button>
                    </p>
                    <!--<div class="basket-coupon-block-form-fields basket-coupon-result{{CLASS}}">
                        <input type="text" class="basket-coupon-block-coupon-input"
                               value="{{COUPON}}" disabled>
                        <input type="button" class="basket-coupon-block-form-close-btn"
                               data-entity="basket-coupon-delete"
                               data-coupon="{{COUPON}}">
                    </div>
                    <div class="basket-coupon-result-text{{CLASS}}">{{JS_CHECK_CODE}}</div>-->                            
                {{/COUPON_LIST}}                
                
                <!--<div class="basket-coupon-block-form-fields">
                    <input type="text" class="basket-coupon-block-coupon-input" data-entity="basket-coupon-input">
                </div>-->                
            <?#}?>
    ...
    <div class="h2 basket-summary-title">Ваш заказ</div>

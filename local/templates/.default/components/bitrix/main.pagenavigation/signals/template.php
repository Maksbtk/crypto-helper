...
<div class="profile-pagination">
    <ul class="profile-pagination-list">
        ...
        <li class="profile-pagination-item _current"><a>1</a></li>
        <li class="profile-pagination-item"><a href="/user/wishlist/?PAGEN_2=2">2</a></li>

        <a class="profile-pagination-button button-next" href="/user/wishlist/?PAGEN_2=2"></a>
    </ul>
</div>
<?php

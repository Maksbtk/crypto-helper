...
<div class="product-suggestion-box product-list-wrapper">
    <div class="h2 product-suggestion-box-title"><?=$arParams['BLOCK_TITLE']?></div>
        ...
        <ul class="products-list product-suggestions-slider products-list__one-line">
            <?foreach ($arResult["ITEMS"] as $item):?>
                ...
                <div class="product-media-wrapper">
                    <a class="product-link" title="<?=$item['NAME']?>" href="<?=$item['DETAIL_PAGE_URL']?>">
                ...
                <div class="product-info-wrapper">
                    <a class="product-link" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$item['NAME']?>"><div class="h4 product-name"><?=$item['NAME']?></div></a>

...
//echo '<pre>'; var_dump($arResult['SKU_PROPS']); echo '</pre>';
?>
<?if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS'])) {?>
    <ul class="profile-section profile-section-favorites">
        <ul class="products-list products-list__full">
            <?
            $arProdIds = [];
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        'PARAMS' => $generalParams
                            + array('SKU_PROPS' => $arResult['SKU_PROPS'][$item['IBLOCK_ID']] , 'SORTED_COLOR' => $sortedColor[$item['PROPERTIES']['CML2_ARTICLE']['VALUE']])
                    ),
                    $component,
                    array('HIDE_ICONS' => 'Y')
                );
...
<?} else {?>
    <section class="profile-section profile-section-favorites">
        <div class="profile-user-empty">
            ...
            <div class="h2">вы еще ничего не добавили</div>

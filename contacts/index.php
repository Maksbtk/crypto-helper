        ...
        <div class="page-contacts-wrapper">
            <div class="page-contacts-box">
                <div class="page-contacts-customer">
                    ...
                    <div class="customer-service-phone">
                        ...
                        <p>
                            Мы на связи ежедневно с 7:00 до 20:00 по московскому времени. Звонки по РФ бесплатно.
                        </p>
                    </div>
                    <div class="customer-service-social">
                        <div class="customer-service-social-line">
                            ...
                            <a href="https://t.me/maksvasa" target="_blank" class="" rel="nofollow">
            ...
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "SUBJECT_FROM" => array(
                        0 => "Сотрудничество",
                        1 => "Проблемы с подпиской",
                        2 => "Предложение/Пожлания",
                    ),
                    "EMAIL_SEND" => "Y",

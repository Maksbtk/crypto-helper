...
$tpCountGeneral = isset($_GET['tpCountGeneral']) ? intval($_GET['tpCountGeneral']) : 5;  // сколько всего тейк профитов у сделки  (false)
...
$tpStrategyAr = [
    0 => ['NAME' => '1.1, 2.2, 3.6, 6, 8.4' , 'VALUE' => [1.1, 2.2, 3.6, 6, 8.4]],
    1 => ['NAME' => '1.3, 2.6, 5.2, 7.8, 10.4' , 'VALUE' => [1.3, 2.6, 5.2, 7.8, 10.4]],
    2 => ['NAME' => '1.4, 2.6, 3.4, 5.6, 6.9' , 'VALUE' => [1.4, 2.6, 3.4, 5.6, 6.9]],
    3 => ['NAME' => '1.4, 2.8, 3.4, 5.6, 6.9' , 'VALUE' => [1.4, 2.8, 3.4, 5.6, 6.9]],
    4 => ['NAME' => '1.9, 2.8, 3.4, 5.6, 6.9' , 'VALUE' => [1.9, 2.8, 3.4, 5.6, 6.9]],
    5 => ['NAME' => '1.5, 2.8, 6, 9, 12' , 'VALUE' => [1.5, 2.8, 6, 9, 12]],
    6 => ['NAME' => '1.7, 2.6, 5.5, 7.4, 9.9' , 'VALUE' => [1.7, 2.6, 5.5, 7.4, 9.9]],
    7 => ['NAME' => '2.4, 3.3, 5.5, 7.4, 9.9' , 'VALUE' => [2.4, 3.3, 5.5, 7.4, 9.9]],
    8 => ['NAME' => '2.5, 3.4, 5.5, 7.4, 9.9' , 'VALUE' => [2.5, 3.4, 5.5, 7.4, 9.9]],
    9 => ['NAME' => '2.6, 3.4, 4.3, 7.4, 9.9' , 'VALUE' => [2.6, 3.4, 4.3, 7.4, 9.9]],
];
